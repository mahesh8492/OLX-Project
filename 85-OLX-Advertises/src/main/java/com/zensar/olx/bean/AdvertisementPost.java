...
public class AdvertisementPost {
		...
		public AdvertisementPost(int id, String title, String description, double price, Category category,
				OLXUser olxUser, AdvertismentStatus advertismentStatus, LocalDate createdDate, LocalDate modifiedDate,
				byte[] photo) {
			super();
			this.id = id;
			this.title = title;
		...
		public String toString() {
			return "AdvertisementPost [id=" + id + ", title=" + title + ", description=" + description + ", price="
					+ price + ", category=" + category + ", olxUser=" + olxUser + ", advertismentStatus="
					+ advertismentStatus + ", createdDate=" + createdDate + ", modifiedDate=" + modifiedDate
